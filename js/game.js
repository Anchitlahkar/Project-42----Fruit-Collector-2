class Game {
  ...
  ScoreData() {
    ...
    var scoreValue = database.ref(playerIndex);
  ...
  play() {
    ...
    fill("white");
    textSize(20);
    text("Player 1 : " + this.player1Score, 20, 50);
    text("Player 1 : " + this.player1Score, 20, 50);
    ...
    fill("white");
    textSize(20);
    text("Player 2 : " + this.player2Score, 20, 80);
    text("Player 2 : " + this.player2Score, 20, 80);
  }
